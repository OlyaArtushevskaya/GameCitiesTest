...
public class GrabCities {
	...
	public GrabCities() {
		...
		// "c:\\temp\\geckodriver\\geckodriver.exe");
		// System.setProperty("webdriver.gecko.driver",
		// "D:\\students\\msm\\geckodriver.exe");
		System.setProperty("webdriver.gecko.driver",
				"c:\\Users\\GAMMA-LF\\AppData\\Local\\Temp\\java\\geckodriver\\geckodriver.exe");
		...
		List<WebElement> searchElements = driver
				.findElements(By.xpath("//table[@class='standard sortable jquery-tablesorter']/tbody/tr/td[3]"));
